...
//                        .requestMatchers("/api/public", "/api/auth/**").permitAll()
                        ...
                        .requestMatchers("/api/agent/**").hasAnyRole("AGENT", "ADMINISTRATEUR")
                        .requestMatchers("/api/expert/**").hasAnyRole("EXPERT", "ADMINISTRATEUR")
                        .requestMatchers("/api/client/**").hasAnyRole("CLIENT", "AGENT", "ADMINISTRATEUR")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
       ...
       // configuration.setAllowedOrigins(Arrays.asList("http://localhost:4200", "http://localhost:3000"));
        // ✅ Autoriser TOUTES les origines (pour mobile + web)
